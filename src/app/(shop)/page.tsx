...
export default function Home() {
  ...
  useEffect(() => {
    // Scroll handling is still used by other sections
  }, []);
    ...
    <div ref={containerRef} className="relative bg-[#050505] text-[#F3EFE9] min-h-screen font-sans selection:bg-[#D2B48C] selection:text-black overflow-x-hidden">
        ...
        <div className="container relative z-10 px-4 text-center pt-48 pb-32">
          ...
          >
            ...
            <h1 className="text-[clamp(3.5rem,10vw,11rem)] font-serif font-light leading-[0.75] mb-10 md:mb-16 tracking-tighter">
              The Pure <br />
              <span className="italic text-white/20 hover:text-[#D2B48C] transition-colors duration-500 cursor-default">Primal</span> Spice.
            </h1>
            <p className="text-[clamp(1.1rem,2vw,1.5rem)] text-white/40 max-w-4xl mx-auto font-light leading-relaxed mb-12 italic font-serif px-6 md:px-4">
            ...
            <div className="flex flex-col sm:flex-row gap-8 justify-center items-center">
              <Button
                ...
                size="lg"
                className="bg-[#D2B48C] hover:bg-white text-black font-bold h-16 px-8 md:px-10 rounded-full text-[9px] md:text-[10px] uppercase tracking-[0.3em] md:tracking-[0.4em] transition-all hover:scale-105 shadow-3xl group relative overflow-hidden w-full sm:w-auto"
              >
        ...
        <div className="container px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <motion.div
              ...
              className="lg:col-span-8 relative h-[24rem] lg:h-[28rem] rounded-[3rem] md:rounded-[5rem] overflow-hidden group border border-white/5 shadow-3xl"
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent p-10 md:p-20 flex flex-col justify-end">
                <h3 className="text-4xl md:text-5xl font-serif text-white mb-6 md:mb-8 tracking-tighter">The Matara Highlands</h3>
            ...
            <motion.div
              ...
              className="lg:col-span-4 relative h-[24rem] lg:h-[28rem] rounded-[3rem] md:rounded-[5rem] overflow-hidden group border border-white/5 shadow-3xl"
            >
              <Image src="/explore/artisan.png" alt="Artisan" fill className="object-cover group-hover:scale-110 transition-all duration-[3s]" />
              <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent p-10 md:p-16 flex flex-col justify-end">
                <span className="text-[#D2B48C] font-bold text-[10px] tracking-[0.6em] uppercase mb-4 block">Artisanal Mastery</span>
                <h3 className="text-3xl md:text-4xl font-serif text-white uppercase font-light leading-none">The 45° <br /><span className="italic">Peel.</span></h3>
              </div>
            </motion.div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {features.map((feature, i) => (
              <motion.div
                ...
                className={cn(
                  "p-12 md:p-20 rounded-[3rem] md:rounded-[5rem] bg-white/[0.02] border border-white/5 hover:border-[#D2B48C]/30 transition-all duration-1000 group relative overflow-hidden",
              ...
              >
                ...
                <p className="text-white/30 text-lg md:text-xl font-light leading-relaxed mb-16 italic border-l border-white/5 pl-8 md:pl-10 font-serif">
                  {feature.desc}
                </p>
      ...
      <section className="py-24 md:py-60 bg-[#050505]">
        <div className="container px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-white/5 rounded-[3rem] md:rounded-[6rem] overflow-hidden border border-white/10 shadow-3xl">
            <CollectionCard
              title="Rare Quills"
              grade="Alba Peak"
              image="/explore/quills.png"
              onSelect={() => setSelectedCollection({
                title: "Rare Quills",
                grade: "Alba Peak",
                description: "Our signature Alba-grade quills, hand-filled by master artisans. Each quill is a testament to physiological perfection, slow-dried to preserve the high Eugenol content and delicate sweet aroma.",
            ...
            <CollectionCard
              ...
              onSelect={() => setSelectedCollection({
                title: "Liquid Gold",
                grade: "Pure Bark Oil",
                description: "Pure steam-distilled cinnamon leaf oil, captured at the first light of dawn. Known for its clarity and potency, this liquid essence embodies the vibrant terroir of our mist-shrouded highlands.",
                ...
                >
                  ...
                  <div className="absolute bottom-0 inset-x-0 p-12 md:p-20 flex justify-between items-end">
                    <div className="max-w-2xl">
                      ...
                      <h3 className="text-4xl md:text-8xl font-serif text-white tracking-tighter leading-none mb-8">{selectedCollection.title}</h3>
                      <p className="text-white/40 font-light italic text-lg md:text-xl max-w-xl border-l border-white/10 pl-8 leading-relaxed">
      ...
      <section className="py-24 md:py-60 relative overflow-hidden bg-[#050505] border-t border-white/5">
        ...
        <div className="container relative z-10 px-4 text-center">
          <motion.div
            ...
            whileInView={{ opacity: 1, scale: 1 }}
            transition={{ duration: 1.5 }}
            className="max-w-6xl mx-auto p-12 md:p-24 lg:p-48 rounded-[3.5rem] md:rounded-[7rem] border border-white/5 bg-black/40 backdrop-blur-3xl shadow-3xl overflow-hidden relative"
          >
            ...
            <p className="text-lg md:text-2xl text-white/40 font-light mb-24 max-w-2xl mx-auto leading-relaxed italic border-x border-white/5 px-8 md:px-16 font-serif">
            ...
            <div className="flex flex-col sm:flex-row gap-8 justify-center mt-12 md:mt-20">
              <Button
                onClick={() => router.push('/contact')}
                className="bg-[#D2B48C] hover:bg-white text-black font-bold h-16 px-8 md:px-12 rounded-full text-[10px] uppercase tracking-[0.3em] md:tracking-[0.4em] shadow-3xl transition-all hover:scale-105 group relative overflow-hidden w-full sm:w-auto"
              >
                <span className="relative z-10">Wholesale Protocol</span>
                <div className="absolute inset-0 bg-white translate-y-full group-hover:translate-y-0 transition-transform duration-500" />
              </Button>
            </div>
          </motion.div>
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent p-10 md:p-20 flex flex-col justify-end">
        ...
        <h3 className="text-4xl md:text-6xl font-serif text-white uppercase mb-8 md:mb-12 font-light tracking-tighter">{title}</h3>
